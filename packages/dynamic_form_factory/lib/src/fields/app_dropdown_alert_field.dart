...
//
// import '../utils/dropdown_dialogs.dart';
// import 'app_dropdown_field.dart';
//
//
// class AppDropdownAlertField<T> extends IAppInputField<List<T>> {
//   AppDropdownAlertField({
//     super.key,
...
//             final internalState = state as _AppDropdownAlertFieldState<T>;
//
...
//               onTap: () async {
//                 DropdownDialogs.showDropdownDialog(
//                   context,
//                   filterTitle: config.label ?? '',
//                   keys: config.options,
//                   initialedKeys: config.initialValue,
//                   values: config.options.map((e) => config.itemLabelBuilder(config.options.indexOf(e))).toList(),
//                 );
//               },
//             );
//           },
...
//
//   @override
//   FormFieldState<List<T>> createState() => _AppDropdownAlertFieldState<T>();
// }
//
// class _AppDropdownAlertFieldState<T> extends FormFieldState<List<T>> {
...
//
//   @override
//   AppDropdownAlertField<T> get widget => super.widget as AppDropdownAlertField<T>;
// }
//
