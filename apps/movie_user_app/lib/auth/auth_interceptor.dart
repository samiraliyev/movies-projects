...
import 'package:movie_user_app/auth/token_storage.dart';
...
class AuthInterceptor extends QueuedInterceptor {
  ...
  Future<void> onRequest(
    ...
    try {
      ...
      options.headers['app-name'] = 'oilink-app';
      ...
      final requestUrl = options.path.cleanUrl();
      ...
      if (isTemporaryUrl) {
        // if (Endpoints.temporaryTokenEndpoints.contains('verify-otp')) {
